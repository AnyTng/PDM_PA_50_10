...
fun ManualView() {
    ...
    val manualUrl = if (isAdmin) adminUrl else colaboradorUrl
    val manualFileName = if (isAdmin) "Manual_administrador.pdf" else "Manual_colaborador.pdf"
    ...
    Column(
        ...
        Button(
            onClick = { downloadManualPdf(context, manualUrl, manualFileName) },
